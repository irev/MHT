...
<tbody>
	<?php 
		$i = 1;
		$query = mysql_query("SELECT * FROM `tb_surat_jalan_teknisi` WHERE id_karyawan='$idkaryawan' ORDER BY `tb_surat_jalan_teknisi`.`id_surat` DESC");
    ...
    ?>
			<a href="#dialog-mahasiswa" onclick="getform.ubah(<?php echo$idg ?>,<?php echo$ids ?>)"  id="<?php echo $data['id_surat'] ?>" class="btn btn-default btn-sm ubah" data-toggle="modal">
