...
<script type="text/javascript">
    ...
    function list_gangguan(){
        $(this).addClass('active');
        $('#data-gangguan').load('pages/tek/mod/gangguan/gangguan.data.php');
    }  
    function list_done(){
        $(this).addClass('active');
        //$(this).removeClass("tot");
        $('#data-gangguan').load('pages/tek/mod/gangguan/gangguan.done.php');
    }
    function list_OnProccess(){
        $(this).addClass('active');
        $('#data-gangguan').load('pages/tek/mod/gangguan/gangguan.OnProccess.php');
    } 
    function list_Pending(){
        $(this).addClass('active');
        $('#data-gangguan').load('pages/tek/mod/gangguan/gangguan.pending.php');
    } 
    function list_surat(){
        $(this).addClass('active');
        $('#data-gangguan').load('pages/tek/mod/gangguan/gangguan.surat.php');
    } 
...
<h3>Data Gangguan</h3>
    ...
    <div id="menu-gangguan"></div>
     ...
     <div class="col-md-10">
		<!-- tempat untuk menampilkan data gangguan -->
...
<script src="pages/tek/mod/gangguan/js/aplikasi.js"></script>
