...
<?php if($_SESSION['login_hash']=="tek"){ ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><?php echo'<a href="dashboard.php?cat=web&page=perangkat"><i class="fa fa-tag"></i> Daftar Perangkat</a>'?></li>
                <li><?php echo'<a href="dashboard.php?cat=web&page=paket"><i class="fa fa-tag"></i> Daftar Paket</a>'?></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
