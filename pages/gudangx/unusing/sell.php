  ...
  var count = 0;
   $("#tambah").click(function(){
     ...
     '<tr class="records">'
       ...
       + '<td><input id="t1' + count + '" name="t1' + count + '" type="text" class="input-small"><font color="red">satuan milimeter</font></td>'
       + '<td><input id="t2' + count + '" name="t2' + count + '" type="text" class="input-small"><font color="red">satuan milimeter</font></td>'
       + '<td><input id="r_ksg' + count + '" name="r_ksg' + count + '" type="text" class="input-small"><font color="red">satuan milimeter</font></td>'
       + '<td><input id="kpk' + count + '" name="kpk' + count + '" type="text" class="input-small"><font color="red">satuan milimeter</font></td>'
       + '<td><input id="tr' + count + '" name="tr' + count + '" type="text" class="input-small"><font color="red">satuan milimeter</font></td>'
       + '<td><a class="remove_item" href="#" >Delete</a><a href="#" class="remove_item btn-xs btn-danger">Delete</a>'
...
<table>
  <tr><td colspan="2"><h3>Inputan Data Mobil Tangki</h3></td></tr>
  
  <tr><td width="150">No. Plat</td><td><input type="text" class="input-small"/></td></tr>
  <tr><td width="150">Kap (KL)</td><td><input type="text" class="input-small"/></td></tr>
  <tr><td width="150">No. SKHP</td><td><input type="text" class="input-large"/></td></tr>
  <tr><td width="150">No. TUM</td><td><input type="text" class="input-large"/></td></tr>
  <tr><td width="150">Masa Berlaku Tera</td><td><input type="text" class="input-large"/></td></tr>
  <tr><td width="150">Jumlah Kompartemen </td><td><input type="button" name="tambah" value="+" id="tambah" class="btn btn-info"/></td></tr>
  <tr><td colspan="2">
      <div class="table table-striped table-bordered table-hover">
        <table width="600" cellpadding="0" cellspacing="0">
          <tr>
            <td background="images/bt.png"><b>No</b></td><td background="images/bt.png"><b>T1</b></td>
            <td background="images/bt.png"><b>T2</b></td><td background="images/bt.png"><b>R Ksg</b></td>
            <td background="images/bt.png"><b>Kpk</b></td><td background="images/bt.png"><b>TR</b></td>
            <td background="images/bt.png"><b>Aksi</b></td></tr>
            <tbody id="container">
        <!-- nanti rows nya muncul di sini -->
            </tbody>
        </table>
  ...
  <tr><td colspan="2"><button type="submit" class="btn btn-default">Submit</button></td></tr>
</table>
</form>
