...
$(document).ready(function() {
   // $('.content').scrollLeft(809); 
    ...
    function tambah_form() {
        ...
        count += 1;
        $('#container').append(
            '<tr class="records">' + '<td><div id="' + count + '" class="urut">' + count + '</div></td>' + '<td class="kdbrang"><input  onchange="cek_kdbarang_sama(' + count + ')" style="width: 100px;"  id="kd_' + count + '" placeholder="Pilih Barang.." name="kd_' + count + '" onClick="barang(' + count + ')" type="text" class="input-small" onfocus="hitung_harga(' + count + ')" readonly autocomplete="off" required/></td>' + '<td style="width: 50%;"><input id="nama_' + count + '" style="width: 100%;" placeholder="Pilih Barang.." name="nama_' + count + '" onClick="barang(' + count + ')" type="text" class="input-small" readonly onfocus="hitung_harga(' + count + ')" readonly autocomplete="off" required/></td>' + '<td style="width: 10%;"><input id="stok_' + count + '" style="width: 100%; text-align: right;" placeholder="Pilih Barang.." name="stok_' + count + '" onClick="barang(' + count + ')" type="text" class="input-small" readonly onfocus="hitung_harga(' + count + ')" autocomplete="off" required/></td>' + '<td style="width: 20%;"> Rp. <input id="harga_' + count + '" name="harga_' + count + '" style="width: 70%; text-align: right;" value="0" style="text-align: right;" type="text" class="harga input-small" readonly autocomplete="off" required/>  X</td>' + '<td style="width: 50px;"><input onkeyup="hitung_harga(' + count + ')" id="jumlah_' + count + '" value="" style="text-align: center;  width: 50px; background-color: rgb(255, 176, 254);" name="jumlah_' + count + '" value="" type="text" class="jumlah_' + count + ' input-small" autocomplete="off" required/></td>' + '<td class="totitem" style="width: 20%;">Rp. <input type="text" id="sum' + count + '" class="tot" style="text-align: right;"  value="0" name="subtot_' + count + '" onClick="totalbelanja()" readonly autocomplete="off" required/></td>' + '<td style="width: 20%;"><span class="label label-danger"><a id="remove_item" class="remove" href="#" style="text-decoration: width: 70%; none; color: #fff;" ><i class="fa fa-fw fa-trash"></i>Delete</a></span>' + '<input id="a_stok_' + count + '" name="a_stok_' + count + '" type="hidden" value="" ></td></tr>' + '<input id="rows_' + count + '" name="rows[]" value="' + count + '" type="hidden"></td></tr>'
        );
        barang(count);
        document.getElementById('add_btn').style.display = 'none';
        document.getElementById('add_btn2').style.display = 'none';
