...
<tbody>
    ...
    ?>
			<a href="#dialog-data" onclick="getform.ubah(<?php echo$idg ?>,<?php echo$ids ?>)"  id="<?php echo $data['id_surat'] ?>" class="btn btn-info btn-sm ubah" data-toggle="modal" style="width: 100%;">
