<?php if($_SESSION['login_hash']=="cs"){ ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><?php echo '<a href="dashboard.php?cat='.$_SESSION['login_hash'].'&page=Daftar_Pelanggan"><i class="fa fa-cubes"></i> Daftar Pelanggan</a>'?></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><?php echo '<a href="dashboard.php?cat=mapsv2&page=index"><i class="fa fa-cubes"></i> Lokasi Repeater</a>'?></li>
                <li><?php echo'<a href="dashboard.php?cat='.$_SESSION['login_hash'].'&page=status"><i class="fa fa-tag"></i> Status Pelanggan</a>'?></li>
                <li><?php echo'<a href="dashboard.php?cat='.$_SESSION['login_hash'].'&page=jenis_pelaporan"><i class="fa fa-tag"></i> Pelangan Baru</a>'?></li>
              </ul>
            </li>
