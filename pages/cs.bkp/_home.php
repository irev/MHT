...
<div class="info-box bg-navy disabled color-palette">
  ...
  <div class="info-box-content bg-aqua">
    ...
    <span class="info-box-number"><?php echo $item['item'].'/'.$barang['totbarang'] ; ?></span>
  </div><!-- /.info-box-content -->
  <div class="info-box-content ">
  <a href="?cat=<?php echo $_SESSION['login_hash']; ?>&page=obat" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
  </div>
</div><!-- /.info-box -->
</div>
<div class="col-md-3">
...
<div class="info-box bg-navy disabled color-palette">
  ...
  <div class="info-box-content bg-yellow">
    ...
    <span class="info-box-number"><?php echo $masuk['masuk']//.' / '.$total_stok['total_stok']; ?></span>
  </div><!-- /.info-box-content -->
  <div class="info-box-content ">
  <a href="?cat=<?php echo $_SESSION['login_hash']; ?>&page=obat" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
  </div>
...
<div class="info-box bg-navy disabled color-palette">
  ...
  <div class="info-box-content bg-red">
    ...
    <span class="info-box-number"><?php echo $keluar['keluar'].' / '.$total_stok['total_stok']; ?></span>
  </div><!-- /.info-box-content -->
  <div class="info-box-content">
  <a href="?cat=<?php echo $_SESSION['login_hash']; ?>&page=obat" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
  </div>
