...
<script type="text/javascript">
	$("#breadcrumb, #judulhal").text('Laporan Perbaikan'); 
	$("#tampil").on("click",function() {
       alert("Tampilkan Laporan Perbaikan ");
       var priode = $("#form-priode").serialize();
       console.log(priode);
       $("#tampil-laporan").html('<iframe src="pages/web/mod/laporan/generate_perbaikan.php?'+priode+'" width="100%" height="500"></iframe>');
    });
</script>
