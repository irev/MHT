...
<div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Pelangan Diblockir</h3>
                ...
                <div class="box-body no-padding">
                  <div class="table-responsive mailbox-messages">
                    <table id="DataTablepelangganBlock" class="table table-hover table-striped">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th></th>
...
<tbody>
  ...
  <tr>
    ...
    <td class="mailbox-attachment">
      <a href="#dialog-data" onclick="getform.ubah(<?php echo "'".$data['id_pelanggan']."'" ?>)"  id="<?php echo $data['id_pelanggan'] ?>" class="btn btn-default btn-sm ubah" >
...
<script> 
$(function () {
   $("#DataTablepelangganBlock").DataTable({
    //"responsive": false,
      "ordering": true,
      "scrollY": "500px",
      "scrollX": true,
