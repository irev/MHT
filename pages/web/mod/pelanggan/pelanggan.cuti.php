...
<div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Pelangan Cuti</h3>
                ...
                <div class="box-body no-padding">
                  <div class="table-responsive mailbox-messages">
                    <table id="DataTablepelangganCuti" class="table table-hover table-striped">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th></th>
...
<tbody>
  ...
  <tr>
    ...
    <td class="mailbox-attachment">
      <a  href="#tab-add" data-toggle="tab"  class="btn btn-default btn-sm ubah" onclick="getform.ubah(<?php echo "'".$data['id_pelanggan']."'" ?>)"  id="<?php echo $data['id_pelanggan'] ?>">
...
<script> 
$(function () {
   $("#DataTablepelangganCuti").DataTable({
    //"responsive": false,
      "ordering": true,
      "scrollY": "500px",
      "scrollX": true,
