...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">   
            <button class="btn btn-sm btn-primary col-md-12" onclick="tampil_semua_koordinat();">Tampilkan Semua Koordinat</button>
        </div>        
        <div class="form-group">   
...
//18-06-2006 SABTU JAM DELAPAN PAGI
// 
//var peta;
var nama     = new Array();
...
if(net::ERR_NAME_NOT_RESOLVED){
	alert('Time out INTERNET ');
}
</script>
<?php
ob_end_flush();
