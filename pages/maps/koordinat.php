...
<?php 
require("../../_db.php");
echo $kdpel = 'CL'.sprintf("%05s",$_POST['id']);
///include('_script.php');
?>
...
<div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Set Koordinat</h3>
            <span style="float:right;"> 
            <a onclick="multi_koordinat()" class="btn  btn-default">
...
<div class="col-md-12">
    <!--div class="col-md-4">
        <div class="form-group" onclick="setjenis(this.value)">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <label>Koordinat X</label>
            	<input type="text" placeholder="latittude" class="form-control input-sm" name="koordinatx" id="koorXmodal" readonly="readonly">
        	</div>
        </div>
    </div>
    <div class="col-md-4">
        ...
        <!--div id="koorAwal" class="form-group">   
        ...
        <div class="form-group">
            ...
            <input type="text"  placeholder="longitude" class="form-control input-sm"  name="koordinaty" id="koorYmodal" readonly="readonly">
        	</div>
        </div>
    </div>
    <div class="col-md-4">
      	<div class="form-group">   
            <button class="btn btn-sm btn-primary col-md-12" onclick="javascript:tampil_semua_koordinat();">Tampilkan Semua Koordinat</button>
        </div> 
        <br>
        <div class="form-group">   
            <button class="btn btn-sm btn-primary col-md-12" onclick="posisi_saat_ini()">Lokasi Saat Ini</button>
        </div>
    </div> 
</div>
</div>
...
//window.onload = loadawal;
console.log(window.location.pathname);
 	   $("#simpan-data").css('visibility', 'hidden');
       $("#simpanpeta").css('visibility', 'hidden');
       $("#namagroup").css('visibility', 'hidden');
       $("#koorAwal").css('visibility', 'hidden');
...
function peta_awal(){
   //console.log(set_icon_tanda(jenis));
    //koorAwal = new google.maps.LatLng(-0.7864794500552789, 100.65369380638003);
...
//$( "#kanvaspeta" ).click(function() {
 //tanda.setMap(null);
//});
//$( "#kanvaspeta" ).dblclick(function() {
...
//});
 function tandai(lokasi){
   ...
   //console.log('tandai lokasi '+ jenis +' '+set_icon(jenis)); 
    ...
    $("#koorXmodal").val(lokasi.lat());
    $("#koorYmodal").val(lokasi.lng());
...
//include('koneksi.php');
    ...
    $js .= 'nama['.$i.'] = "'.$value['nama'].'";
            ...
            var contentString = "<table style=\'color:black;\'>"+
                                        "<tr>"+
                                            "<td><b>" + nama['.$i.'] + "</b></td>"+
                                        "</tr>"+
                                        "<tr>"+
